...
function Sidebar() {
  ...
  const sidebardataFetch = () => {
    axios
      .get("http://65.1.132.27/api/getStoriesList/getBookList", {
  ...
  const createNewBook = () => {
    axios
      .post("http://65.1.132.27/api/storyData/createBook", {
        data: {
          ...
          {saveTitleButton ? (
            <span
              ...
              onClick={(e) => {
                ...
                axios
                  .post("http://65.1.132.27/api/storyData/updateBookTitle", {
                    data: {
                      bookId: bookId,
          ...
          >
            <button
              ...
              onClick={(e) => {
                console.log("Gone");
                axios
                  .post("http://65.1.132.27/api/storyData/deleteBook", {
            ...
            <button
              ...
              onClick={(e) => {
                console.log("Gone");
                axios
                  .post("http://65.1.132.27/api/storyData/createPage", {
                    data: {
                      jwtToken:userData.jwtToken,
                      bookId: bookId,
